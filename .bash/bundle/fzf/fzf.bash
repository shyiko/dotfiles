...
fzf() {
  /usr/bin/ruby --disable-gems ~/.bash/bundle/fzf/fzf "$@"
}
export -f fzf > /dev/null

# Auto-completion
# ---------------
[[ $- =~ i ]] && source ~/.bash/bundle/fzf/fzf-completion.bash
...
__fsel_tmux() {
  ...
  tmux split-window $height "bash -c 'source ~/.bash/bundle/fzf/fzf.bash; tmux send-keys -t $TMUX_PANE \"\$(__fsel)\"'"
}
